...
oGrid.initGrid();
oGrid.setSendUrl("/contents/statistics/data/statChargeGrid.do");
...
var columns = [
	...
	{ field: "sumCharge", title: "운송비", width: 70,
		template: function(dataItem) {
			return Util.formatNumber(dataItem.sumCharge);
		},
		attributes: { 
...
function createChart(param) {
    ...
    $("#chart").kendoChart({
    	dataSource: {
            transport: {
                read: {
                    url: "/contents/statistics/data/statCharge.do",
                    type : "post",
                    dataType: "json",
                    data : param,
