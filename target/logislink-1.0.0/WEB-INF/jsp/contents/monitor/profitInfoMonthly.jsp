					...
					for(var i=0, item; item=response.cust[i]; i++) {
						...
						for(var j=0, item2; item2=response.data[j]; j++) {	
							if(item.custId == item2.custId && item.deptId == item2.deptId) {
								...
								sellData["col" + day] = Util.nvl(Util.formatNumber(item2.sellAmt),"0");
								buyData["col" + day] = Util.nvl(Util.formatNumber(item2.buyAmt),"0");
								profData["col" + day] = Util.nvl(Util.formatNumber(item2.sellAmt - item2.buyAmt),"0");
								var perData = 0;
								if (item2.sellAmt != item2.buyAmt && item2.sellAmt != 0) perData = (item2.sellAmt - item2.buyAmt) / item2.sellAmt * 100;
								percData["col" + day] = perData.toFixed(1)+"%";
