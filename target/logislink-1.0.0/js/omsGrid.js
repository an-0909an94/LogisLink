...
function gridData(id) {
	...
	this.setDetailTemplate = function (detailTemplate){
							this.gridOption.detailTemplate = detailTemplate;
						  }
	this.setGrid		= function (columns) {
												this.gridOption.columns = columns;
												
												// setDetailTemplate 데이터 넘겨줄때만 표시 
							        			if(this.gridOption.detailTemplate != ""){
								        			var detailTemplateItem = this.gridOption.detailTemplate
							        			} else {
								        			var detailTemplateItem = null
							        			}
												$("#" + this.id).kendoGrid({
									        		...
									        		detailTemplate: detailTemplateItem,
													navigatable: true,
