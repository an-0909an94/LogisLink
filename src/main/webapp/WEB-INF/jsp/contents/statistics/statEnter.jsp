...
oGrid.initGrid();
oGrid.setSendUrl("/contents/statistics/data/statEnterGrid.do");
...
var columns = [
	...
	{ field: "rate", title: "입차준수율", width: 70 }
];
...
function createChart(param) {
    ...
    $("#chart").kendoChart({
    	dataSource: {
            transport: {
                read: {
                    url: "/contents/statistics/data/statEnter.do",
                    type : "post",
                    dataType: "json",
                    data : param,
