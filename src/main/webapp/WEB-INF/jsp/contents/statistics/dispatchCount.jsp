				...
				<div class="form-group row" style="justify-content: space-between">
					<div class="row">
						...
						<c:if test="${authChk}">
							...
							<!--
							<div style="padding: 1em;" class="input-group input-group-sm wd290"></div>
							-->
						</c:if>
					</div>
...
oGrid.initGrid();
oGrid.setSendUrl("/contents/statistics/data/dispatchCountGrid.do");
...
function createChart(param) {
    ...
    $("#chart").kendoChart({
    	dataSource: {
            transport: {
                read: {
                    url: "/contents/statistics/data/dispatchCount.do",
                    type : "post",
                    dataType: "json",
                    data : param,
