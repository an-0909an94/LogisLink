...
oGrid.initGrid();
oGrid.setSendUrl("/contents/statistics/data/statUrgentGrid.do");
...
var columns = [
	...
	{ field: "cnt", title: "긴급완료건수", width: 70 },
	{ field: "rate", title: "긴급대응률", width: 70 }
];
...
function createChart(param) {
    ...
    $("#chart").kendoChart({
    	dataSource: {
            transport: {
                read: {
                    url: "/contents/statistics/data/statUrgent.do",
                    type : "post",
                    dataType: "json",
                    data : param,
