                    ...
                    <form id="f" data-toggle="validator" role="form">
	                    <fieldset>
							...
							<div class="editor_btns order_editor_btns" style="text-align: center;">
								<div class="padding">
									<button type="submit" class="k-pager-refresh k-button btn_58 btn_b" id="btnSubmit"><b class="btn-b">
							...
							<div class="form-group row gray_box">
								...
								<div class="form-group row mt10">
									...
									<div class="input-group input-group-sm wd100 middle-name form-group" >
										<strong>아이디확인</strong>
										<button style="width: 100%;" class="form-control form-control-sm a-text-center" id="btn_chkUserId">중복확인</button>
									</div>
								</div>
								<div class="form-group form-group-sm row chgPasswd mt10">
								...
								<div class="form-group row writePasswd mt10 ">
									<label class="col-form-label"></label>
								...
								<div class="form-group row mt10">
									<label class="col-form-label"></label>
									<div class="input-group input-group-sm wd140 middle-name form-group div-min-col-1">
									...
									<div class="input-group input-group-sm col middle-name" style="margin-right: 7px">
