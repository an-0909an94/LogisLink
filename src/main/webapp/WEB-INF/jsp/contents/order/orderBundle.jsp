...
var columns = [
	...
	{ field: "reqDeptName", title: "담당부서", width: 100},
	...
	{ field: "sStaff", title: "상차지담당자", width: 120},
	...
	{ field: "sMemo", title: "상차지메모", width: 120},
	...
	{ field: "eStaff", title: "하차지담당자", width: 120},
	...
	{ field: "eMemo", title: "하차지메모", width: 120},
	...
	{ field: "allocCharge", title: "청구운임", width: 100,
		template: function(dataItem) {
	...
	{ field: "buyCharge", title: "지불운임", width:100,
		template: function(dataItem) {
	...
	{ field: "driverTel", title:"연락처", width: 100,
		template: function(dataItem) {
			var driverTel = dataItem.driverTel;
			return Util.formatPhone(driverTel);
		}	
	},
	{ field: "allocDate", title: "배차일시", width: 100,
		template: function(dataItem) {
...
function setGridData(data) {
	...
	var dataSource = new kendo.data.DataSource({
		...
		schema: {
			model: {
				fields: {
					reqCustName: {type:"string", validation: {required: true, validationMessage: "거래처명을 입력해 주세요."}},
					reqDeptName: {type:"string", validation: {required: true, validationMessage: "담당부서를 입력해 주세요."}},
					sComName: {type:"string", validation: {required: true, validationMessage: "상차지명을 입력해 주세요."}},
 					sAddr: {type:"string", validation: {required: true, validationMessage: "상차지 주소를 입력해 주세요."}},
					sAddrDetail: {type:"string"},
					sDate: {type:"string", validation: {required: true, validationMessage: "상차일시를 입력해 주세요."}},
					sTime: {type:"string"},
					sStaff: {type:"string", validation: {required: true, validationMessage: "상차지 담당자를 입력해 주세요."}},
					sTel: {type:"string", validation: {required: true, validationMessage: "상차지 연락처를 입력해 주세요."}},
					sMemo: {type:"string"},
					eComName: {type:"string", validation: {required: true, validationMessage: "하차지명을 입력해 주세요."}},
					eAddr: {type:"string", validation: {required: true, validationMessage: "하차지 주소를 입력해 주세요."}},
					eAddrDetail: {type:"string"},
					eDate: {type:"string", validation: {required: true, validationMessage: "하차일시를 입력해 주세요."}},
					eTime: {type:"string"},
					eStaff: {type:"string", validation: {required: true, validationMessage: "하차지 담당자를 입력해 주세요."}},
					eTel: {type:"string", validation: {required: true, validationMessage: "하차지 연락처를 입력해 주세요."}},
					eMemo: {type:"string"},
					inOutSctn: {type:"string", validation: {required: true, validationMessage: "수출입 구분을 입력해 주세요."}},
...
function viewErrDriverInfo(){
	...
	if(errDriverInfo == null) {
		...
		errDriverInfo.refresh({url: "/contents/order/errDriverInfo.do"});
	} 
...
function viewErrReqInfo(){
	...
	if(errReqInfo == null) {
		...
		errReqInfo.refresh({url: "/contents/order/errReqInfo.do"});
	} 
