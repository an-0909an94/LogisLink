...
<link rel="stylesheet" type="text/css" href="<c:url value='/css/omsStyle.css'/>">
...
<script type="text/javascript" src="<c:url value='/js/omsGrid.js'/>"></script>
<script type="text/javascript" src="<c:url value='/js/util.js'/>"></script>
<script type="text/javascript" src="<c:url value='/js/common.js'/>"></script>
<script type="text/javascript" src="<c:url value='/js/order.js?v=11'/>" ></script>
